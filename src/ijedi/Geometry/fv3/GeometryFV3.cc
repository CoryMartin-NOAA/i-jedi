...
namespace ijedi
{
                           ...
                           const eckit::mpi::Comm &comm)
  {
    ...
    // Create a grid (example uses a simple lat-lon grid, FV3 would use cubed-sphere)
    ...
    // This would contain geometry-related fields like surface height, land mask, etc.
    ...
    // TODO: Add more FV3-specific fields as needed:
    // - Land/sea mask
