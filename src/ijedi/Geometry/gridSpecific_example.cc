...
// This demonstrates how State or other classes can safely access grid information
...
namespace ijedi
{
    ...
    void exampleUsage(const Geometry &geom)
    {
        ...
        if (gridType == "fv3")
        {
            ...
            std::cout << "FV3 grid: " << npx << " x " << npy << " x " << npz << std::endl;
        ...
        else if (gridType == "mpas")
        {
            ...
            std::cout << "MPAS mesh: " << nnodes << " nodes, "
                      << ncells << " cells, " << nedges << " edges" << std::endl;
        }
        else if (gridType == "mom6")
        {
            ...
            std::cout << "MOM6 grid: " << ni << " x " << nj << " x " << nk << std::endl;
        }

        // Safe access with defaults
        int someParam = gridInfo.getInt("some_optional_param", -999); // Returns -999 if not found
    ...
    {
    public:
        StateExample(const Geometry &geom)
        {
